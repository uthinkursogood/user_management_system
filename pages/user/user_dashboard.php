...
<div class="profile-container">
    <div class="profile-card">
        ...
        <div class="action-buttons">
            <?php if ($user['role'] === 'admin'): ?>
                ...
                <a href="../admin/admin_dashboard.php" class="btn btn-custom btn-success">
    ...
    <div class="profile-card">
        ...
        <?php if ($user['role'] === 'admin'): ?>
            <div class="mt-3">
                <a href="../admin/admin_dashboard.php" class="btn btn-outline-primary">
                    <i class="bi bi-people me-2"></i>Go to Admin Dashboard
                </a>
            </div>
        <?php endif; ?>
    </div>
